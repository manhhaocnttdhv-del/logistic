...
<section class="content">
    <div class="container-fluid">
        <form action="{{ route('admin.import-orders.store') }}" method="POST" id="importOrderForm">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="text-muted d-block mt-1">Hệ thống sẽ tự động chọn nhân viên nhập kho phù hợp</small>
                                @error('position')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.import-orders.index') }}" class="btn btn-secondary px-4">
