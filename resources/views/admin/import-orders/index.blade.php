    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header bg-gradient-primary">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-end">
                        <div class="btn-group">
                            <a href="{{ route('admin.import-orders.create') }}" class="btn btn-light btn-sm">
                                <i class="bi bi-plus-circle me-1"></i> Tạo phiếu nhập
                            </a>
                            <a href="{{ route('admin.import-orders.export') }}" class="btn btn-success btn-sm">
            ...
            <div class="card-body p-3">
                <form method="GET" action="{{ route('admin.import-orders.index') }}" class="mb-3">
                    <div class="row g-2">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-5">
                            ...
                            <a href="{{ route('admin.import-orders.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-clockwise me-1"></i>Làm mới</a>
                        </div>
                    </div>
                </form>
                        ...
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($order->status == 'pending')
                                        <a href="{{ route('admin.import-orders.edit', $order) }}" class="btn btn-sm btn-warning">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                    @endif
                                    @if($order->status == 'completed')
                                        <a href="{{ route('admin.import-orders.pdf', $order) }}" class="btn btn-sm btn-danger" target="_blank">
