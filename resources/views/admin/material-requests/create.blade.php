...
<section class="content">
    <div class="container-fluid">
        <form action="{{ route('admin.material-requests.store') }}" method="POST" id="materialRequestForm">
            @csrf
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="{{ route('admin.material-requests.index') }}" class="btn btn-secondary px-4">
